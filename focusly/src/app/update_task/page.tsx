        ...
        <div className="bg-gray-300 min-h-screen font-nunito">
            ...
            <main className="container mx-auto my-8 max-w-3xl px-6 py-6 bg-white shadow-md rounded-md">
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="task" className="block text-base font-semibold text-gray-800">New Task Description</label>
                        <input type="text"
                               id="task"
                               value={task}
                    ...
                    <div>
                        <label htmlFor="deadline_date" className="block text-base font-semibold text-gray-800">New Task Deadline</label>
                        <input type="date"
                               id="deadline_date"
                               value={deadline}
